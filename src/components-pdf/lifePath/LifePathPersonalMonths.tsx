...
export default function LifePathPersonalMonths({ consultant, now, newDate }: { consultant: Person, now: SplittedDate, newDate: Date }) {
  ...
  const isQuarterOne = quarterOne.find((month) => month === capitalize(actualMonth));
  const isQuarterTwo = quarterTwo.find((month) => month === capitalize(actualMonth));
  const isQuarterThree = quarterThree.find((month) => month === capitalize(actualMonth));
  const isQuarterFour = quarterFour.find((month) => month === capitalize(actualMonth));
