      ...
      <div className="grid">
        ...
        <div className="col-start-2 col-end-8">
          <div className="h-12 grid grid-cols-7">
            {daysCustomSingle.map((d, index) => <div key={d || index} className="bg-gray-30  p-3 border border-black px-1 text-center text-gray-500 ">{d ? d[0] : ''}</div>)}
          </div>
            ...
            {daysInMonthSingle.map((day) => (
              ...
              >
                ...
                <span className="text-xl flex justify-center text-black font-bold">
                  ...
                  /
                  {u.calcUniversalDay({ ...calculationDate, month: selectedMonth, day })}
                  {u.calcUniversalDayISK({ ...calculationDate, month: selectedMonth, day })}
                </span>
              </div>
            ))}
          </div>
...
export default PartnersSingleMonth;
