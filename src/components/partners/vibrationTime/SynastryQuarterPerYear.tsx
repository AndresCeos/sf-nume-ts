  ...
  return (
    ...
    >
      <div className="grid grid-cols-11 grid-rows-14 w-full mx-4 my-8 ">
        ...
        col-start-${i + 3}  row-start-3 row-span-5 text-5xl flex justify-center items-center border border-gray-500 text-gray-500 `}
            >
        ...
        col-start-${i + 3} row-start-8 row-span-4  text-5xl flex justify-center items-center border border-gray-500 text-gray-500`}
            >
              {synastry.getQuarterTwo(year)}
              {synastry.getQuarterTwoISK(year)}
            </div>
            <div
              className={`
      ${indexOfMonth === 0 && year === newDate.year ? ' font-bold' : ''}
      ...
      ${year !== newDate.year ? 'text-gray-500' : ''}
      col-start-${i + 3} row-start-12 row-span-4  text-5xl flex justify-center items-center border border-gray-500 text-gray-500 `}
            >
              {synastry.getQuarterThree(year)}
              {synastry.getQuarterThreeISK(year)}
            </div>
          </>
        ))}
      </div>
